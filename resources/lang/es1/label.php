...
return [
    ...
    'rightholders.template' => 'Estimados padres y/o tutores legales:<br>A través de este correo les solicitamos autorización para el tratamiento de imágenes, captación y publicación, del alumno/a como participante/es en los eventos que se realicen y organicen en el centro escolar, en relación con la función educativa, durante el curso 2018/2019. <strong>Importante:</strong> conserve este correo pues en el caso de que quiera modificar en cualquier momento su decisión puede ejercer su derecho a través de este enlace. <br><br> Reciba un cordial saludo, <br> Muchas gracias.
',
